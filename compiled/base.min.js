! function (a, b, c, d) {
    ...
    c.extend(h, {
        ...
        open: function (a, b) {
            ...
            }), h.opts = c.extend(!0, {}, h.defaults, b), void 0 !== b.keys && (h.opts.keys = !!b.keys && c.extend({}, h.defaults.keys, b.keys)), h.group = a, h._start(h.opts.index)
        },
        cancel: function () {
            var a = h.coming;
            !1 !== h.trigger("onCancel") && (h.hideLoading(), a && (h.ajaxLoad && h.ajaxLoad.abort(), h.ajaxLoad = null, h.imgPreload && (h.imgPreload.onload = h.imgPreload.onerror = null), a.wrap && a.wrap.stop(!0, !0).trigger("onReset").remove(), h.coming = null, h.current || h._afterZoomOut(a)))
        },
        close: function (a) {
        ...
        play: function (a) {
            ...
            !0 === a || !h.player.isActive && !1 !== a ? function () {
        ...
        jumpto: function (a, b, c) {
            var d = h.current;
            d && (a = p(a), h.direction = b || d.direction[a >= d.index ? "next" : "prev"], h.router = c || "jumpto", d.loop && (a < 0 && (a = d.group.length + a % d.group.length), a %= d.group.length), void 0 !== d.group[a] && (h.cancel(), h._start(a)))
        },
        ...
        bindEvents: function () {
            var a, b = h.current;
            b && (f.bind("orientationchange.fb" + (k ? "" : " resize.fb") + (b.autoCenter && !b.locked ? " scroll.fb" : ""), h.update), a = b.keys, a && g.bind("keydown.fb", function (d) {
                var e = d.which || d.keyCode,
                    f = d.target || d.srcElement;
                if (27 === e && h.coming) return !1;
                d.ctrlKey || d.altKey || d.shiftKey || d.metaKey || f && (f.type || c(f).is("[contenteditable]")) || c.each(a, function (a, f) {
        ...
        changeIn: function () {
            var a, b = h.current,
                ...
                f = h.direction;
            d.opacity = .1, "elastic" === c && (a = "down" === f || "up" === f ? "top" : "left", "down" === f || "right" === f ? (d[a] = q(p(d[a]) - 200), e[a] = "+=200px") : (d[a] = q(p(d[a]) + 200), e[a] = "-=200px")), "none" === c ? h._afterZoomIn() : h.wrap.css(d).animate(e, {
        ...
        var b, d;
        void 0 === c.scrollbarWidth && (c.scrollbarWidth = function () {
            var a = c('<div style="width:50px;height:50px;overflow:auto"><div/></div>').appendTo("body"),
                b = a.children(),
                d = b.innerWidth() - b.height(99).innerWidth();
            return a.remove(), d
        }), void 0 === c.support.fixedPosition && (c.support.fixedPosition = function () {
            ...
            parent: c("body")
        }), b = c(a).width(), e.addClass("fancybox-lock-test"), d = c(a).width(), e.removeClass("fancybox-lock-test"), c("<style type='text/css'>.fancybox-margin{margin-right:" + (d - b) + "px;}</style>").appendTo("head")
    })
    ...
    $(window).scroll(function () {
        $(this).scrollTop() > 220 ? $(".scroll-top").fadeIn(500) : $(".scroll-top").fadeOut(500)
